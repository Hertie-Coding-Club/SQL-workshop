...
dbGetQuery(con, "SELECT id FROM epex_12_20_12_13 WHERE price > 10")

# Select only trades with a price greater than 10, on the buy side
dbGetQuery(con, "SELECT id FROM epex_12_20_12_13 WHERE price > 10 AND side = 'buy'")


# How many trades have a quantity below 15?
dbGetQuery(con, "SELECT COUNT(id) FROM epex_12_20_12_13 WHERE quantity < 15")
